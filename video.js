...
//aliases
  ...
  */
            ...
            now = ((ref = video.performance) != null ? (ref1 = ref.now) != null ? ref1.bind(video.performance) : void 0 : void 0) || Date.now;


               ready(function() {
                   var button, capture, gif, info, sample, sampleInterval, sampleUpdate, startTime, timer, video,Height,Width,img;
                   info = document.id('info');
                   video = document.id('recorder');
                   button = document.id('go');
                   sample = document.id('sample');
                   img = document.id('result');
                   ///////////////
                   img.height = window.videoH +"px";
                   img.width = window.videoW +"px";
                   console.log("1111")
                   console.log("imgWidth2:", img.width);
                   console.log("imgHeight2:",img.height);
                   console.log("windowvideoH2:",window.videoH );
                   console.log(" windowvideoW2:",  window.videoW);
                   ///////////
                   ...
                   gif.on('finished', function(blob) {
                       ...
                       var delta, img;
                       img = document.id('result');
                       // img.style.cssText='width:' + myCanvas.offsetWidth + 'px\nheight:' +myCanvas.offsetHeight + "px"
                       // console.warn(" img.style.cssText12212： ",  img.style.cssText)

                       // /////////////
                       // img.height = window.videoH +"px";
                       // img.width = window.videoW +"px";
                       console.log("imgWidth3:", img.width);
                       console.log("imgHeight3:",img.height);
                       console.log("windowvideoH3:",window.videoH );
                       console.log(" windowvideoW3:",  window.videoW);
